...
export const FOODS = [
  ...
  new Food(
    ...
    30,
    '5',
    'https://cdn.shopify.com/s/files/1/1995/9093/files/iki-bardak-espresso-lungo.jpg?v=1678102312',
    ['Espresso Kahve Çekirdekleri']
  ),
  new Food(
    'm19',
    ['c9'],
    ...
    ['Espresso', 'Süt', 'Krema', 'Vanilya Şurubu']
  ),
  new Food(
    'm20',
    ['c9'],
    ...
    110,
    '80',
    'https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_4:3/k%2FPhoto%2FRecipe%20Ramp%20Up%2F2022-07-Cappuccino%2FCappuccino',
    ['Espresso', 'Süt Köpüğü', 'Kakao Tozu']
  ),
  new Food(
    'm21',
    ['c10'],
  ...
  new Food(
    ...
    130,
    '100',
    'https://image.milimaj.com/i/milliyet/75/0x0/5f7775de55427f106c67c0f3.jpg',
    ['Taze Sıkılmış Elma']
  ),
  new Food(
    'm23',
    ...
    160,
    '120',
    'https://www.ticomachine.com/uploads/allimg/What-kind-of-fruit-matches-pineapple-perfect-while-making-juice.jpg',
    ['Taze Sıkılmış Ananas']
  ),
  new Food(
    'm24',
    ['c11'],
    ...
    280,
    '220',
    'https://d2lswn7b0fl4u2.cloudfront.net/photos/pg-vegan-chocolate-milkshake-in-jar-1641676525.jpg',
    ['Süt', 'Çikolata Parçaları', 'Dondurma', 'Vanilya Ekstraktı']
  ),
  new Food(
    'm25',
    ['c11'],
    ...
    250,
    '200',
    'https://icecektarifleri.net/wp-content/uploads/2023/06/muzlu-milkshake-tarifi.jpg',
    ['Süt', 'Muz Dilimleri', 'Dondurma', 'Bal']
  ),
  new Food(
    'm26',
    ['c11'],
    ...
    270,
    '210',
    'https://cdn.yemek.com/mncrop/940/625/uploads/2014/07/cilekli-milkshake-tarifi-yepyeni-10.jpg',
    ['Süt', 'Çilek Dilimleri', 'Dondurma', 'Bal']
  ),
  new Food(
    'm27',
    ['c12'],
    ...
    5,
    '2',
    'https://www.diyetkolik.com/site_media/media/customvideo_images/st_1.jpg',
    ['Siyah Çay Poşeti', 'Sıcak Su', 'Şeker (isteğe bağlı)']
  ),
  new Food(
    'm28',
    ['c12'],
    ...
    5,
    '2',
    'https://static.toiimg.com/photo/78092190.cms',
    ['Yeşil Çay Poşeti', 'Sıcak Su', 'Şeker (isteğe bağlı)']
  ),
  new Food(
    'm29',
    ['c12'],
    ...
    10,
    '5',
    'https://cdn.muhiku.com/blog/wp-content/uploads/2019/09/Zencefil-Bal-ve-Karanfil-%C3%87ay%C4%B1-800x480.jpg',
    ['Nane Yaprakları', 'Siyah Çay Poşeti', 'Sıcak Su', 'Şeker (isteğe bağlı)']
  ),
  new Food(
    'm30',
    ['c13'],
    ...
    180,
    '120',
    'https://d17wu0fn6x6rgz.cloudfront.net/img/w/blok/d/cilekli-smoothie.webp',
    ['Taze Çilek', 'Yogurt', 'Bal', 'Buz']
  ),
  new Food(
    'm31',
    ['c13'],
    'Mango-Peynirli Smoothie',
    200,
    '140',
    'https://www.beyzayalav.com/wp-content/uploads/2020/11/mago-lassi.jpg',
    ['Taze Mango', 'Peynir', 'Bal', 'Buz']
  ),
  new Food(
    'm32',
    ['c13'],
    ...
    220,
    '150',
    'https://i.lezzet.com.tr/images-xxlarge-recipe/avokadolu-smoothie-1b6eea95-7657-42a8-aa41-0b7b5a2e4b08.jpg',
    ['Taze Avokado', 'Yogurt', 'Bal', 'Buz']
  )
